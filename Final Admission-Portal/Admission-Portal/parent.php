...
<title>Parent Information - Admission Portal (Student)</title>
<script language=JavaScript>
function nextj()
{
	var r= confirm("You are redirecting to Co-curricular & Extra Curricular Information without saving data.");
	if(r == true)
...
<form name="form" action="s_parent.php" method="post" enctype="multipart/form-data">
...
<tr><th align="left">Full Name of Parent:<font color="red" size="2">*</font></th><td><input required type="text" size="98" maxlength="50" name="parent_name" value=<?php echo $parent_name?>></td></tr>
<tr><th align="left">Address of Parent:<font color="red" size="2">*</font></th><td><textarea required rows="2" cols="100" name="parent_add"><?php echo $parent_add?></textarea></td></tr>
<tr><th align="left">Phone Number of Parent:<font color="red" size="2">*</font></th><td><input required type="text" size="98" maxlength="50" name="parent_ph" value=<?php echo $parent_ph?>></td></tr>
<tr><th align="left">Full Name of Guardian:</th><td><input type="text" size="98" maxlength="50" name="guardian_name" value=<?php echo $guardian_name?>></td></tr>
<tr><th align="left">Relation with Guardian:</th><td><input type="text" size="98" maxlength="50" name="guardian_relationship" value=<?php echo $guardian_relationship?>></td></tr>
<tr><th align="left">Address of Guardian:</th><td><textarea rows="2" cols="100" name="guardian_add"><?php echo $guardian_add?></textarea></td></tr>
<tr><th align="left">Phone Number of Guardian:</th><td><input type="text" size="98" maxlength="50" name="guardian_ph" value=<?php echo $guardian_ph?>></td></tr>
<tr><th align="left">Profession & Address of Parent Office:<font color="red" size="2">*</font></th><td><textarea required rows="2" cols="100" name="parent_off_add"><?php echo $parent_off_add?></textarea></td></tr>
<tr><th align="left">Phone Number of Parent Office:<font color="red" size="2">*</font></th><td><input required type="text" size="98" maxlength="50" name="parent_off_ph" value=<?php echo $parent_off_ph?>></td></tr>
<tr><th align="left">Profession & Address of Guardian Office:</th><td><textarea rows="2" cols="100" name="guardian_off_add"><?php echo $guardian_off_add?></textarea></td></tr>
<tr><th align="left">Phone Number of Guardian Office:</th><td><input type="text" size="98" maxlength="50" name="guardian_off_ph" value=<?php echo $guardian_off_ph?>></td></tr>
<tr><th align="left">Address of Native Place:</th><td><textarea rows="2" cols="100" name="native_add"><?php echo $native_add?></textarea></td></tr>
<tr><th align="left">Phone Number of Native Place:</th><td><input type="text" size="98" maxlength="50" name="native_ph" value=<?php echo $native_ph?>></td></tr>
<tr><th align="left">Parent Total Income:<font color="red" size="2">*</font></th><td><input required type="text" size="98" maxlength="50" name="parent_income" value=<?php echo $parent_income?>></td></tr>
<tr><th align="left">Guardian Total Income:</th><td><input type="text" size="98" maxlength="50" name="guardian_income" value=<?php echo $guardian_income?>></td></tr>
</table>
<table>
