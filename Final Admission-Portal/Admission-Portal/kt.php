...
<title>Academic ATKT Information - Admission Portal (Student)</title>
<script language=JavaScript>
function prevj()
{
	var r= confirm("You are redirecting to Cocurricular & Extra-curricular Information without saving data.");
	if(r == true)
...
function nextj()
{
	var r= confirm("You are redirecting to Photo Upload without saving data.");
	if(r == true)
...
function sub()
{
	var a= document.getElementById("kt1").checked;
	if(!(a))
		{
		var b= document.getElementById("kt2").checked;
		if(!(b))
			{
			alert("Select Either one Status.");
			return false;
			}
		else
			{
			if(document.getElementById("kt2").value =="kt")
				{
				if(document.getElementById("kt_no").value == "")
					{
					alert("Number of KT can not be blank.");
					return false;
					}
				}
			}
...
<form name="form" action="s_kt.php" method="post" enctype="multipart/form-data">
...
if($_SESSION['year']=='SE')
	{
	$text1="I have passed Semster - I to Semester - II examinations with out any backlog and have enclosed all the zerox copies of the marksheets.";
	$text2="I have  a backlog of";
	$text3="heads of passing in Sem-I and Sem-II examinations considered together and have enclosed all the zerox copies of the marksheets.";
	}
if($_SESSION['year']=='TE')
	{
	$text1="I have passed Semster - I to Semester - IV examinations with out any backlog and have enclosed all the zerox copies of the marksheets.";
	$text2="I have passed Sem I & Sem II examinations and have a backlog of";
	$text3="heads of passing in Sem-III and Sem-IV examinations considered together and have enclosed all the zerox copies of the marksheets.";
	}
if($_SESSION['year']=='BE')
	{
	$text1="I have passed Semster - I to Semester - VI examinations with out any backlog and have enclosed all the zerox copies of the marksheets.";
	$text2="I have passed Sem I & Sem IV examinations and have a backlog of";
	$text3="heads of passing in Sem-V and Sem-VI examinations considered together and have enclosed all the zerox copies of the marksheets.";
	}
?>
<table class="border"><tr><td>
<input type="radio" id="kt1" name="kt" value="pass" <?php echo ($pass_kt== 'pass') ?  "checked" : "" ;  ?>><?php echo $text1?></br></br>
<input type="radio" id="kt2" name="kt" value="kt" <?php echo ($pass_kt== 'kt') ?  "checked" : "" ;  ?>><?php echo $text2?><input type="text" id="kt_no" name="kt_no" value="<?php echo $kt?>" size="5" maxlength="2"><?php echo " ";?><?php echo $text3?></br></br>
</td></tr></table>
<center>
<table>
<tr><th colspan="6"><input type="button" class="button" onclick="prevj()" name="prev" value="Previous">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="button" onclick="nextj()" name="next" value="Next">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="button" onclick="return sub()" name="submit" value="Save & Next">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" class="button" name="reset" value="Reset"></th></tr>
</table>
</center>
</span>
</form>
