...
<title>Photo Upload - Admission Portal (Student)</title>
<script language=JavaScript>
function prevj()
{
	var r= confirm("You are redirecting to Academic ATKT Information without saving data.");
	if(r == true)
...
function nextj()
{
	var r= confirm("You are redirecting to Print Form without saving data.");
	if(r == true)
...
<form name="form" action="s_photo.php" method="post" enctype="multipart/form-data">
...
<table class="border">
<tr>
<td><img alt="no image" src="<?php echo $photo_path?>" width="150px" height="200px"></td><td><input id="uploadFile" type="file" name="fileToUpload"></td>
</tr>
</table>
<font color="red" size="3">Note: Image should be of size 150px (width) by 200px (height) for better resolution.</font>
<table>
